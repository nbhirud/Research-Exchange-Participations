...
<html>
    ...
    <body>
        ...
        <div id="header">
            <nav id="header_menu">
                <ul  class="left" >
                    <li><a class= "headtitle" href="UserController?action=main">Researchers Exchange Participations</a></li>
                </ul>
                <ul class="right">
                    <c:if test="${theUser == null}">
                        ...
                        <c:if test="${theUser.type == 'Participant'}">
                        ...
                        <c:if test="${theUser.type == 'Administrator'}">
                        <li><a href="aboutl.jsp">About Us</a></li>
                        <li><a href="admin.jsp">How it Works</a></li>
                        <li>Hello, ${ theUser.name} (Admin)</li>
                        <li><a href = "UserController?action=logout">Logout</a></li>
                        </c:if>
                </ul>
